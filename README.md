...
😎 Sou desenvolvedor Javascript, Typescript, NodeJS, React, React Native, PHP e Delphi <br>
...
<details open>
  ...
  | [NLW-Pocket 🚀](https://github.com/luiizsilverio/nlw-pocket) | Node + Fastify + DrizzleORM / React + Tailwind + Radix-UI + TanStack Query |
...
<details open>
  ...
  | [EJS-Mongo](https://github.com/luiizsilverio/mongo-ejs) | Node + EJS + MongoDB + Multer |
